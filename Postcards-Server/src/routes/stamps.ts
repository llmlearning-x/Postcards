...
const STAMP_IMAGE_PATHS: Record<string, string> = {
  // Series I · 旅行
  classic:  'serie-i-travel/classic-stamp-art.webp',
  nature:   'serie-i-travel/nature-stamp-art.webp',
  culture:  'serie-i-travel/culture-stamp-art.webp',
  city:     'serie-i-travel/city-stamp-art.webp',
  ocean:    'serie-i-travel/ocean-stamp-art.webp',
  sunset:   'serie-i-travel/sunset-stamp-art.webp',
  // Series II · 古迹
  greatwall:  'serie-ii-heritage/greatwall-stamp-art.webp',
  terracotta: 'serie-ii-heritage/terracotta-stamp-art.webp',
  pagoda:     'serie-ii-heritage/pagoda-stamp-art.webp',
  garden:     'serie-ii-heritage/garden-stamp-art.webp',
  canal:      'serie-ii-heritage/canal-stamp-art.webp',
  // Series III · 四季
  spring: 'serie-iii-seasons/spring-cherry-stamp-art.webp',
  summer: 'serie-iii-seasons/summer-lotus-stamp-art.webp',
  autumn: 'serie-iii-seasons/autumn-maple-stamp-art.webp',
  winter: 'serie-iii-seasons/winter-snow-stamp-art.webp',
  // Series IV · 节气
  lichun:      'serie-iv-solar-terms/lichun-stamp-art.webp',
  qingming:    'serie-iv-solar-terms/qingming-stamp-art.webp',
  xiazhi:      'serie-iv-solar-terms/xiazhi-stamp-art.webp',
  liqiu:       'serie-iv-solar-terms/liqiu-stamp-art.webp',
  shuangjiang: 'serie-iv-solar-terms/shuangjiang-stamp-art.webp',
  dahan:       'serie-iv-solar-terms/dahan-stamp-art.webp',
  // Series V · 远方
  prairie:  'serie-v-faraway/grassland-stamp-art.webp',
  snowpeak: 'serie-v-faraway/snow-mountain-stamp-art.webp',
  desert:   'serie-v-faraway/desert-stamp-art.webp',
  island:   'serie-v-faraway/island-stamp-art.webp',
}
